...
- (void)viewDidLoad
{
  ...
  UIImage *qrcode = [self createNonInterpolatedUIImageFormCIImage:[self createQRForString:@"https://www.zhihu.com/people/salex"] withSize:125];
  
  UIImage *customQrcode = [self imageBlackToTransparent:qrcode withRed:60.0f andGreen:74.0f andBlue:89.0f];
  
  UIImage *walleImage = [UIImage imageNamed:@"wall-e"];
  
  customQrcode = [customQrcode drawImage:walleImage inRect:CGRectMake(62 - 16, 62 - 16, 32, 32)];
